...
FM_CLAUDE_AUTOARM_RENEWAL_BUDGET=27000   # seconds a Claude Stop auto-arm may hold one arm open before renewing continuity; must stay safely below the declared hook timeout (28800) that kills the whole hook process group
