...
`tests/fm-supervision-events.test.sh` covers the event-wait splice, including the actionable rc=0 arm that proves the ownership gate is inert with no watcher runtime rather than terminating a sourcing shell.
