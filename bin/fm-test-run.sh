...
family_for_basename() {
  case "$1" in
    ...
    fm-launch-health-lib.test.sh|\
    fm-lint-workflows.test.sh|fm-no-mistakes-required-gate.test.sh|\
    fm-operational-input.test.sh|fm-pi-primary-types.test.sh|\
    fm-send-popup-settle.test.sh|fm-send-settle.test.sh|\
    fm-subagent-pretool-check.test.sh|\
    fm-supervision-instructions.test.sh|fm-task-delivery.test.sh|\
    fm-tmux-submit-busy.test.sh|fm-trace-context-lib.test.sh|\
    fm-transition-lib.test.sh|fm-wake-resident.test.sh|\
    ...
    fm-herdr-session-cleanup-e2e.test.sh|fm-secondmate-manual-mode-e2e.test.sh|\
    ...
    fm-autostart-herdr-live-e2e.test.sh|\
    ...
    fm-herdr-recalibration-live-e2e.test.sh|\
    fm-herdr-attention-live-e2e.test.sh|\
    fm-opencode-primary-live-e2e.test.sh|fm-pi-primary-live-e2e.test.sh|\
    fm-sessionstart-hook-live-e2e.test.sh|fm-sessionstart-instruction-refresh-live-e2e.test.sh|\
    fm-quota-array-dispatch-live-e2e.test.sh|fm-send-secondmate-marker-herdr-e2e.test.sh|\
    fm-send-inbox-doorbell-live-e2e.test.sh|\
    fm-herdr-busy-state-live-e2e.test.sh|\
    ...
    fm-herdr-attention-config.test.sh|\
