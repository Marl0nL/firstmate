...
description: >-
  ...
  Use when creating, seeding, validating, launching, recovering, handing backlog to, pushing inherited config into, or retiring a secondmate home, when raising or standing down a wake-resident secondmate, or when editing data/secondmates.md.
  Covers home leases, transactional seeding, project clone restrictions, secondmate harness pins, inherited config push, idle charter, handoff helper, wake-residency, and teardown safety.
...
Use this reference before creating, seeding, validating, launching, handing backlog to, recovering, pushing inherited config into, or retiring a persistent secondmate, before raising or standing down a wake-resident one, and before editing `data/secondmates.md`.
...
Reach for the recovery path below only when it is dormant *and* has pending mail that a raise cannot clear.
